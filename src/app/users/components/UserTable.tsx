...
export function UserTable({
    ...
    const handleExpandUser = React.useCallback((userId: string) => {
    ...
    const filteredByRole = members.filter(
        (user) => activeFilters.length === 0 || user.roles.some((role) => activeFilters.includes(role.shortname)),
    );
                ...
                <div className="user-table-header-controls">
                    ...
                    <div className="relative">
                        <Button
                            variant="outline"
                            size="sm"
                            className="user-table-sort-trigger dropdown-trigger"
                        ...
                        {sortDropdownOpen && (
                            <div className="absolute right-0 z-50 mt-1 min-w-[8rem] overflow-hidden rounded-md border bg-[#1a1d29] border-gray-800/60 text-white shadow-lg dropdown-menu">
                                <div className="px-2 py-1.5 hover:bg-[#1e2235]/80 cursor-pointer" onClick={() => handleSort("name")}>
                                    Name {sortField === "name" && (sortOrder === "asc" ? "↑" : "↓")}
                                </div>
                                <div
                                    className="px-2 py-1.5 hover:bg-[#1e2235]/80 cursor-pointer"
                                ...
                                <div className="px-2 py-1.5 hover:bg-[#1e2235]/80 cursor-pointer" onClick={() => handleSort("role")}>
                                ...
                                <tr className="user-table-row" onClick={() => handleExpandUser(user.discordId)}>
                                    <td className="user-table-name-cell">
                                        <div className="flex items-center gap-2">
                                            <Avatar>
                                                <AvatarImage src={user.avatar} alt={user.username} className="max-w-[40px] max-h-[40px]" />
                                                <AvatarFallback>
                                                    {(() => {
                                                        try {
                                            ...
                                            <div>
                                                ...
                                                <div className="user-table-discordId text-xs truncate max-w-[150px] md:max-w-[200px]">
                                                    {user.discordId}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="user-table-actions-container">
                                            ...
                                            <div className="relative">
                                                <Button
                                                    variant="ghost"
                                                    size="icon"
                                                    className="user-table-action-btn dropdown-trigger"
                                                    onClick={(e) => toggleActionDropdown(user._id || user.discordId, e)}
                                                >
                                                ...
                                                {activeActionDropdown === (user._id || user.discordId) && (
                                                    <div className="absolute right-0 z-50 mt-1 min-w-[8rem] overflow-hidden rounded-md border bg-[#1a1d29] border-gray-800/60 text-white shadow-lg dropdown-menu">
                                                        <div
                                                            className="px-2 py-1.5 hover:bg-[#1e2235]/80 cursor-pointer"
                                                            onClick={(e) => handleManageRoles(user, e)}
                                                        >
                                                            Manage Roles
                                                        </div>
                                                        <div
            ...
            <div className="user-table-footer">
                <div className="user-table-showing flex items-center gap-2 text-sm">
                    ...
                    <select
                        ...
                        className="user-table-page-select-trigger"
                    >
